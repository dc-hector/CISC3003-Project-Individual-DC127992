      ...
      <div class="row">
         ...
         <form action="" method="POST">
            ...
            <div class="flex">
               ...
               <div class="box">
                  ...
                  <input type="text" name="street" required maxlength="50" placeholder="e.g. street name & locality"
                     class="input">
                  ...
                  <input type="number" name="pin_code" required maxlength="6" placeholder="e.g. 123456" class="input"
                     min="0" max="999999">
               </div>
            </div>
         ...
         <div class="summary">
               ...
               while ($fetch_get = $select_get->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  <div class="flex">
                     ...
                     <div>
                        ...
                        <p class="price"><i class="fas fa-yen-sign"></i> <?= $fetch_get['price']; ?> x 1</p>
                     </div>
                  </div>
                  <?php
               }
                  ...
                  while ($fetch_cart = $select_cart->fetch(PDO::FETCH_ASSOC)) {
                     ...
                     <div class="flex">
                        ...
                        <div>
                           ...
                           <p class="price"><i class="fas fa-yen-sign"></i> <?= $fetch_product['price']; ?> x
                              <?= $fetch_cart['qty']; ?></p>
                        </div>
                     </div>
                     <?php
            ...
            <div class="grand-total"><span>grand total :</span>
               <p><i class="fas fa-yen-sign"></i> <?= $grand_total; ?></p>
            </div>
         </div>
