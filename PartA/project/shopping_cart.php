   ...
   <section class="products">
            ...
            while ($fetch_cart = $select_cart->fetch(PDO::FETCH_ASSOC)) {
               ...
               if ($select_products->rowCount() > 0) {
                  ...
                  <form action="" method="POST" class="box">
                     ...
                     <div class="flex">
                        <p class="price"><i class="fas fa-yen-sign"></i> <?= $fetch_cart['price']; ?></p>
                     ...
                     <p class="sub-total">sub total : <span><i class="fas fa-yen-sign"></i>
                           <?= $sub_total = ($fetch_cart['qty'] * $fetch_cart['price']); ?></span></p>
      ...
      <?php if ($grand_total != 0) { ?>
         <div class="cart-total">
            <p>grand total : <span><i class="fas fa-yen-sign"></i> <?= $grand_total; ?></span></p>
